    ...
    <section className="analytics">
        ...
        <div className="analytics__left-banner"></div>
            <div className="analytics__container">
                ...
                text="Изучаем поведение аудитории и конкурентов на предмет продвижения в интернете, изучаем сетку конкурентов и их вложения в развитие бизнеса, опросы и рекламные движения. Такая аналитика позволит до создания продукта уже знать под какое продвижение мы его прорабатываем, а после запуска проекта грамотно продвигать и получать отличную конверсию."/>
                <div className="analytics__empty-block"></div>
            </div>
            <div className="analytics__right-banner"></div>
            </section>
